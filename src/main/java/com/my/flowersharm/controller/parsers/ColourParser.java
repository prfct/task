 ...
 */
public class ColourParser extends Parser<String> {
    private static final Pattern VALID_NAME_REGEX = Pattern.compile("^[a-zA-Z][a-zA-Z0-9-_\\.]{2,10}$");
    private static final String INCORRECT_NAME = "Incorrect colour, 3 to 10 characters it can be letters or numbers," +
            " first should be letter";
    private StringParser stringParser = new StringParser();
    private Map<String, Object> errors;

    public ColourParser(Map<String, Object> errors) {
        this.errors = errors;
    }
